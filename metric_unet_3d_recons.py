...
if __name__ == '__main__':
    ...
    data_filepath = '/staff/ydli/projects/Med_Seg/seg/new_inf/kbr/v1.9.0/fold5/hdf5_eval'
    ...
    csv_dict = {'sid_mode':sid_list, 'data_path': data_filelist,
    ...
    df.to_csv('/staff/ydli/projects/Med_Seg/seg/new_inf/kbr/v1.9.0/fold5/metrics_eval_unet.csv')